...
class CalculatorBrain {
  CalculatorBrain(
      ...
      required this.monthlyOilBill,
      required this.Mileage,
      required this.flightsIn4hrsLess,
      required this.flightsIn4hrsMore});
  ...
  double CalculateGHGFootprint() {
    _CfootprintResult = (monthlyElectricityBill * 105) +
        (monthlyGasBill * 105) +
        (monthlyOilBill * 113) +
        (Mileage * 79) +
        (flightsIn4hrsLess * 1100) +
        (flightsIn4hrsMore * 4400);
